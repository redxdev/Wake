...
test.test('creation', function()
    ...
    test.expect_error(Matrix3x3.new, 1, 2)
end)
...
test.test('quat', function()
    local m = Matrix3x3.new(1, 2, 3, 4, 5, 6, 7, 8, 9)
    local q = m:quat()
    test.expect_num_equal(q:get(1), -0.25, 0.000001)
    test.expect_num_equal(q:get(2), 0.5, 0.000001)
    test.expect_num_equal(q:get(3), -0.25, 0.000001)
    test.expect_num_equal(q:get(4), 2, 0.000001)
end)